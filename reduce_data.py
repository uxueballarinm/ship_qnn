...
if __name__ == "__main__":
    ...
    file_path = "datasets\zigzag_10_40_ood.csv"
    ...
    reduce_dataset(file_path, mode='time_interval', output_path="datasets\zigzag_10_40_ood_reduced_2_s.csv", value=2.0, time_col='Time (s)')
